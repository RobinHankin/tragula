...
The editor will come to a decision based on the available reviews,
which may not all make the same recommendation.
...
\item Section editor chooses one of the following:
  ...
  \item Revise or resubmit: reviews passed to author for
