...
you find some aspect of a submission is particularly interesting or
...
review process: do not feel the need to be overly polite or to protect
the feelings of the authors.  In particular, if you do not understand
some part of the submission, do not feel embarrassed to say so:
remember that you are an expert in the field, and editors will find
such candid comments valuable.  Authors often find that succinct and
well-placed feedback can catalyse much improved writing and
programming.
...
But comments should be strictly confined to the submission, not the
authors.  Before sending a review, go through it and delete
unnecessarily harsh or statements.  Check carefully for unclear,
unfair or biased comments.  Be polite, be firm, but be fair and be
kind.  If you recommend revision or rejection of the manuscript, do so
gently.  Add a compliment or compliments if at all possible.  Authors
will be unhappy with a bad review (it is the editor's job to deal with
complaints) but should feel that their work was taken seriously and if
possible should have a good idea of what would be required for an
...
suggestions because they are ``obvious''; but a direct suggestion is
often a helpful spur to improvement.  It also helps editors decide
whether the reviews have been properly engaged with.  Remember that
the authors have right of reply and are free to decline to carry out a
suggestion (but the editor may well take a dim view of this strategy,
unless the authors give clear reasons for not doing so).
...
\item Section editor chooses one of the following:
  ...
  \item Revise and resubmit: reviews passed to author for
    ...
    an extremely effective way of doing this).
  \item Reject.
  \end{itemize}
...
\subsection{Post-publication maintenance}
