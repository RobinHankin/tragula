...
%% just as usual
\author{Robin K. S. Hankin\\Auckland University of Technology \And A. N. Other\\National University of Ruritania}
...
\Abstract{Abstract goes here, not more than a couple of paragraphs.
  You can follow ISO 214:1976 if you wish, no obligation.  Do not
  include citations here.  In a nutshell: {\em Tragula} is a
...
that showcases their software with apt and informative examples, as
in:
